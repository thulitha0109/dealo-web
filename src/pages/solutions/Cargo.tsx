...
import Image from '../../assets/images/CargoInsuranceSolutions.jpg'
import Layout from '../Layout';

const CargoInsurance = () => (
    <Layout>
    <div className="flex flex-col items-center py-12 bg-white">
      <h1 className="text-2xl font-semibold mb-6 text-left">Your cargo is safe with us!</h1>
        ...
        {/* <div className="flex flex-col py-12 bg-white">
          <p className="text-center text-sm font-semibold mt-2 text-gray-600 max-w-2xl">
